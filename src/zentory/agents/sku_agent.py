    ...
    async def propose_actions(self, event: dict[str, Any]) -> list[Action]:
        ...
        return [
            Action(
                ...
                evidence=[
                    {"source": "sales", "label": "week_units", "value": card.sales.week_units},
                    {
                        "source": "stock",
                        "label": "coverage_days",
                        "value": card.stock.coverage_days,
                    },
                    {
                        "source": "ads",
                        "label": "drr_percent",
                        "value": card.advertising.drr_percent,
                    },
                    {"source": "reviews", "label": "rating", "value": card.reviews.rating},
                ],
            )
        ]
