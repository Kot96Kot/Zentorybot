...
@lru_cache
def get_sku_intelligence_service() -> SKUIntelligenceService:
    return SKUIntelligenceService()


@lru_cache
def get_supply_planner_service() -> SupplyPlannerService:
    return SupplyPlannerService()


@lru_cache
def get_content_ctr_service() -> ContentCTRService:
    return ContentCTRService()


@lru_cache
def get_finance_checker_service() -> FinanceCheckerService:
    return FinanceCheckerService()


@lru_cache
def get_action_result_service() -> ActionResultService:
