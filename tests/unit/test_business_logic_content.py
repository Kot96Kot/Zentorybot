...
@pytest.mark.xfail(strict=True, reason="Generic content actions can be LOW/NONE in SafetyRules")
...
@pytest.mark.xfail(strict=True, reason="Content publication has no explicit approval policy")
...
@pytest.mark.xfail(
    strict=True, reason="Mass content-change actions are not escalated to hard approval"
)
